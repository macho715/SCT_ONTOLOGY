...
현재 상태는 Cloudflare Workers 전환 기준입니다. MCP 서버, 6개 tool, 온톨로지 corpus 번들, Evidence Drawer 위젯, D1 감사 로그 바인딩, R2 파일 바인딩, golden eval, GitHub Actions 검증이 들어 있습니다.
...
Cloudflare Workers 원격 MCP와 Claude stdio bridge가 동일한 6개 tool 이름을 공유합니다.
