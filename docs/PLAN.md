...
| 작성일 | 2026-05-10 |
| 기준 시간대 | Asia/Dubai |
| 기준 문서 | `docs/uiux/HVDC_Ontology_Grounded_ChatGPT_App_UIUX_Spec_2026-05-10.docx` |
...
- `render_hvdc_answer_card`만 ChatGPT 카드 template를 소유합니다. 출력 template는 `ui://hvdc/answer-card-v7.html`입니다.
- `ui://hvdc/answer-card-v6.html`, `ui://hvdc/answer-card-v5.html`, `ui://hvdc/render_hvdc_answer_card.html`는 같은 HTML을 반환하는 호환 alias입니다.
