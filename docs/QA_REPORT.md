...
- `render_hvdc_answer_card` owns the answer-card template `ui://hvdc/answer-card-v8.html`.
- Registered UI resources include canonical v8, previous v7, legacy v6/v5, and render tool alias:
