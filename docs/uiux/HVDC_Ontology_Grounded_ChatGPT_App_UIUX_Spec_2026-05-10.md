...
`uiTemplate` metadata belongs to `ask_hvdc_ontology`. Search-only tools such as `search_ontology_corpus` return structured evidence data without directly attaching the iframe.
