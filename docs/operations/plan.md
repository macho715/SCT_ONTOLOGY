...
현재 상태: HVDC Ontology ChatGPT App은 GitHub에 공개 업로드되었고 기본 검증 workflow는 존재하지만, 문서 변경부터 배포 반영, 앱 제출 품질, 보안 감시, 평가 운영까지는 아직 하나의 운영 체계로 묶이지 않았다.
...
- Railway MCP 배포: `https://hvdc-ontology-chatgpt-app-production.up.railway.app/mcp`
...
| C | 운영 플랫폼화: B에 GitHub Projects, Railway 자동 배포, 릴리스/승인 workflow까지 연결 | 5.0-8.0 | public repo, deployment secret, 운영 권한 관리 리스크 증가 | 0-소액 |
...
- Railway 자동 배포와 GitHub Projects는 B가 안정된 뒤 붙이는 편이 안전하다.
