...
| ValidationFinding | ruleId, severity, status, targetObject, evidenceIds, message | SHACL/SPARQL/RAG/Human-gate 검증 결과 |
...

{
 ...
 "validation": [{"ruleId":"V-AGIDAS-001", "status":"BLOCK", "severity":"BLOCK"}],
 "actions": [{"actionType":"REQUEST\_MOSB\_EVIDENCE", "ownerRole":"Marine Lead", "humanGateRequired":true}],
 "\_meta": {"uiTemplate":"ui://hvdc/answer-card.html", "piiMasked":true}
}
