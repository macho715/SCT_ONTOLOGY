...
# HVDC Upgrade Summary Report (v3.6-APEX TDD)

## Connections
- [[CostGuard Business Rule Engine]] - `describes` [EXTRACTED]
- [[PII Masking & Audit Logging (SHA-256 integrity)]] - `describes` [EXTRACTED]

#graphify/document #graphify/EXTRACTED #community/Audit_Evidence_Boundary_Phase_1_EVID-04__PII_Masking__Audit_Logging_SHA-256_integrity__HVDC_Upgrade_Summary_Report_v36-APEX_TDD