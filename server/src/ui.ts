...
export const WIDGET_URI = "ui://hvdc/answer-card-v9.html";
export const PREVIOUS_WIDGET_URI = "ui://hvdc/answer-card-v8.html";
export const LEGACY_WIDGET_URI = "ui://hvdc/answer-card-v7.html";
export const V6_WIDGET_URI = "ui://hvdc/answer-card-v6.html";
export const V5_WIDGET_URI = "ui://hvdc/answer-card-v5.html";
export const TEMPLATE_VERSION = "answer-card-v9";
